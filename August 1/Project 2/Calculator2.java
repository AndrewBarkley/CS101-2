...
public class Calculator2
{
      ...
      if (tokens == 3 && tokenNum == 2)
      {
         ...
         switch(operator)
         {
            ...
            case "/":
               if (operand2 == 0)
               {
                  System.out.print("Hey stupid! You can't divide by 0");
               }
               else
               {
                  result = operand1 / operand2;
            ...
            case "%":
               if (operand2 == 0)
               {
                  System.out.print("Hey stupid! You can't divide by 0, even if it is to find the modulus.");
               }
               else
               {
                  result = operand1 % operand2;
   ...
   */
   ...
   four                          Scanner that will read inputLine       
   var2IsNum                     Boolean that equals true if the second token is an unused number
